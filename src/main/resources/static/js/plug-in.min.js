(function (a) {
    ...
    jQuery.Pop = function (g, e, c) {
        function h() {
            a("#" + f).removeClass("showAlert");
            a("#" + f).addClass("hideAlert");
            0 < a("#" + f + "bg").length && a("#" + f + "bg").fadeOut(400, function () {
                a(this).remove()
            });
            setTimeout(function () {
                a("#" + f).remove()
        ...
        function m() {
            var c = "pop_" + (new Date).getTime() + parseInt(1E5 * Math.random());
            return 0 < a("#" + c).length ? m() : c
        }
        ...
        }, e ? e instanceof Object ? e : k[e] || {} : {}), l = a("<div>").addClass("box").addClass(d.Class);
        e = a("<div>").addClass("box-title");
        var k =
                a("<i>").html("\u00d7"), p = a("<div>").addClass("box-content"), q = a("<div>").addClass("box-button"),
            n = a("<div>").css({
                position: "fixed",
                left: 0,
                top: 0,
        ...
        a("body").append(l.append(e.html(d.Title).append(k)).append(p.html(g)).append(q.html(function () {
            var c = a("<div>"), b = d.Btn;
            b.yes && c.append(a("<span>").addClass(b.yes.class).html(b.yes.vla).click(b.yes.ope));
            b.no && c.append(a("<span>").addClass(b.no.class).html(b.no.vla).click(b.no.ope));
            b.cancel && c.append(a("<span>").addClass(b.cancel.class).html(b.cancel.vla).click(b.cancel.ope));
            b.bnt1 && c.append(a("<span>").addClass(b.bnt1.class).html(b.bnt1.vla).click(b.bnt1.ope));
            b.bnt2 && c.append(a("<span>").addClass(b.bnt2.class).html(b.bnt2.vla).click(b.bnt2.ope));
            b.bnt3 && c.append(a("<span>").addClass(b.bnt3.class).html(b.bnt3.vla).click(b.bnt3.ope));
            b.bnt4 && c.append(a("<span>").addClass(b.bnt4.class).html(b.bnt4.vla).click(b.bnt4.ope));
            b.bnt5 && c.append(a("<span>").addClass(b.bnt5.class).html(b.bnt5.vla).click(b.bnt5.ope));
            return c
        }()))).append(n);
        l.css({
            "margin-left": .5 * -l.width(),
            "margin-top": .5 * -l.height(),
            "z-index": d.ZIndex
        }).addClass("showAlert").attr("id", f).attr("data-animation", d.Animation);
        k.click(h);
        d.BoxDrag && e.mouseover(function () {
            a(this).css("cursor",
                "move")
        }).mousedown(function (c) {
            var b = !0, d = c.pageX - a(this).parent().offset().left, e = c.pageY - a(this).parent().offset().top;
            a(document).mousemove(function (a) {
                b && l.offset({left: a.pageX - d, top: a.pageY - e}).css({"margin-left": 0, "margin-top": 0})
            }).mouseup(function () {
                b = !1
            })
        })
    ...
    jQuery.Pro = function (g, e) {
        ...
        $Box = a("<div>").css({
            ...
            top: "50%",
            "max-width": "300px",
            "background-color": "rgba(0,0,0," + c.BoxBgopacity + ")",
            padding: "13px 18px",
            color: "#fff",
            "border-radius": " 6px",
            "line-height": "30px",
        ...
        $BoxHtml = a("<p>").css({width: "100%", margin: "0", padding: "0"}).html(g);
        $BoxImg = a("<img>").attr({src: c.Img});
        a("body").append($Box.append($BoxHtml));
        c.Img && $Box.prepend($BoxImg);
        c.ImgWh && (g = c.ImgWh.split("*"), $BoxImg.attr({
            width: g[0],
            height: g[1]
        }));
        $Box.css({"margin-left": .5 * -$Box.outerWidth(), "margin-top": .5 * -$Box.outerHeight(), "z-index": c.ZIndex});
        c.StartOn && c.StartOn();
        setTimeout(function () {
